...
class MakeActionServiceCommand extends GeneratorCommand
{
    protected $name = 'make:api-action-service';
    protected $description = 'Create a new API ActionService class';

    protected $type = 'ActionService';

    protected function getStub()
    {
        $customPath = base_path('stubs/vendor/api-kit/action-service.stub');

        if (file_exists($customPath)) {
            return $customPath;
        }

        return __DIR__.'/stubs/action-service.stub';
    }
